...
documentTypes = [".pdf", ".chm", ".djv", ".pds", ".txt", ".djvu", ".xls", ".ppt" ,
                  ".doc", ".docx", ".one" , ".mobi" , ".rtf" ] 
codeTypes = [".c" , ".cpp" , ".c++" , ".h" , ".js" , ".css" , ".java" , ".bat" , ".php", 
             ".py", ".html", ".htm", ".xhtml" , ".obj", ".cs" , ".xml" , ".vb" , ".sln" ,
              ".xaml", ".resx" , ".resw" , ".aspx" ]
